    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1[class],h2[class],h3[class],h4[class],h5[class],h6[class],hr[style|class],b[class|style],u[style|class],strong[style|class],span[style|class],i[style|class],em[style|class],s,del,div[class],a[href|title|class|style],ul[style|class],ol,li[style|class],p[style|class],br[style|class],span[style|class],img[width|height|alt|src|class],blockquote',
